...
import styles from "./EditarNoticiaPage.module.css";
    ...
    return (
      <div className={styles.container}>
        <div className={styles.error}>
          ...
          <Link to="/autor/noticias">Voltar para Minhas Notícias</Link>
        </div>
      </div>
    );
  }
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.pageHeader}>
          ...
          <span className={`${styles.statusBadge} ${noticia.publicada ? styles.published : styles.draft}`}>
